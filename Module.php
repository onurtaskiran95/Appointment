...
class Module extends \kouosl\base\Module
{
    ...
    public function registerTranslations()
    {
        Yii::$app->i18n->translations['site/*'] = [
            ...
            'basePath' => '@kouosl/Appointment/messages',
            'fileMap' => [
                'Appointment/Appointment' => 'Appointment.php',
            ],
        ];
    }
    ...
    {
        return Yii::t('Appointment/'. $category, $message, $params, $language);
    }
